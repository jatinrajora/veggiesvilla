...
public class CustomSearchRecyclerAdapter extends RecyclerView.Adapter<CustomSearchRecyclerAdapter.ViewHolder> {
    ...
    public CustomSearchRecyclerAdapter(Context context, ArrayList<Item> items) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new CustomSearchRecyclerAdapter.ViewHolder(view);
    }
